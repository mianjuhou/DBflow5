...
public class JSONModel<TModel extends Model> extends BaseModelContainer<TModel, JSONObject> implements Model {
    ...
    /**
     * Constructs this object with the {@link JSONObject} for the specified {@link TModel} table.
     *
    ...
    /**
     * Constructs this object with an empty {@link JSONObject} referencing the {@link TModel} table.
     *
     * @param table The table of the referenced model
     */
