...
public class FlowCursorList<TModel extends Model> {
     ...
     * The cache size will default to the {@link Cursor#getCount()}
     *
     ...
     *
     * @param position The row number in the {@link Cursor} to look at
    ...
    /**
     * @return the count of the rows in the {@link Cursor} backed by this list.
     */
    public int getCount() {
        throwIfCursorClosed();
        warnEmptyCursor();
