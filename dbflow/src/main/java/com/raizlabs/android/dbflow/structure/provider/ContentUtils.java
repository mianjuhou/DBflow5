...
public class ContentUtils {
    ...
    /**
     * Inserts the model into the {@link ContentResolver}. Uses the insertUri to resolve
     * the reference and the model to convert its data into {@link ContentValues}
     *
     * @param insertUri    A {@link Uri} from the {@link ContentProvider} class definition.
    ...
    /**
     * Updates the model through the {@link ContentResolver}. Uses the updateUri to
     * resolve the reference and the model to convert its data in {@link ContentValues}
     *
     * @param updateUri    A {@link Uri} from the {@link ContentProvider}
    ...
    /**
     * Deletes the specified model through the {@link ContentResolver}. Uses the deleteUri
     * to resolve the reference and the model to {@link ModelAdapter#getPrimaryConditionClause(Model)}
     *
     * @param deleteUri    A {@link Uri} from the {@link ContentProvider}
    ...
    /**
     * Queries the {@link ContentResolver} with the specified query uri. It generates
     * the correct query and returns a {@link Cursor}
     *
     * @param contentResolver The content resolver to use (if different from {@link FlowManager#getContext()})
    ...
    /**
     * Queries the {@link ContentResolver} with the specified queryUri. It will generate
